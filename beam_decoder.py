...
def beam_search(model, src, src_mask, max_len, pad, bos, eos, beam_size, device, src_token_type_ids):
    ...
    with torch.no_grad():
        # -- Encode
        src_enc = model.encode(src, src_mask.squeeze(-2), src_token_type_ids)
